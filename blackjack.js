...
dCard1 = cards[Math.floor(Math.random() * cards.length)];
dCard2 = cards[Math.floor(Math.random() * cards.length)];
pCard1 = cards[Math.floor(Math.random() * cards.length)];
pCard2 = cards[Math.floor(Math.random() * cards.length)];


document.getElementById("dealerCard1").innerHTML = dCard1;
